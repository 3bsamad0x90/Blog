...
@section("content")
    <div class="card mt-2">
        ...
        <div class="card-body">
            ...
            <p class="card-title">
                <b>Description:</b> {{ucfirst(trans($post -> description))}}
            </p>
        </div>
    </div>
    <div class="card mt-2">
        ...
        <div class="card-body">
            <p class="card-title"><b>Name:</b> {{ucfirst(trans($post -> title))}}</p>
            <p class="card-title"><b>Email:</b> {{ucfirst(trans($post -> user-> email))}}</p>
            <p class="card-title">
